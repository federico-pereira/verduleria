...
public class UsuarioController {
    ...
    @Operation(summary = "Ver lista usuarios", responses = {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Encontrar usuario especifico", responses = {
    ...
    public ResponseEntity<Usuario> updateUsuario(
        ...
        Usuario savedUsuario = usuarioService.updateUsuario(id, updatedUsuario);
